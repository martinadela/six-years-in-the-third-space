...
vec3 worley_dist(vec3 x, vec3 y, vec3 z,  bool manhattanDistance) {
...
float Kzo = 0.416666666667; // 1/2-1/6*2
	...
	vec3 d11 = worley_dist(dx11, dy11, dz11, manhattanDistance);
	vec3 d12 =worley_dist(dx12, dy12, dz12, manhattanDistance);
	vec3 d13 = worley_dist(dx13, dy13, dz13, manhattanDistance);
	vec3 d21 = worley_dist(dx21, dy21, dz21, manhattanDistance);
	vec3 d22 = worley_dist(dx22, dy22, dz22, manhattanDistance);
	vec3 d23 = worley_dist(dx23, dy23, dz23, manhattanDistance);
	vec3 d31 = worley_dist(dx31, dy31, dz31, manhattanDistance);
	vec3 d32 = worley_dist(dx32, dy32, dz32, manhattanDistance);
	vec3 d33 = worley_dist(dx33, dy33, dz33, manhattanDistance);
