;(function () {
    ...
    class Lights {
        constructor(camera, scene) {
            ...
            this.directionalLight.position.setFromSpherical(directionalLightSphericalPosition)
            camera.add(this.directionalLight)

            window.light = this.spotLight = new THREE.SpotLight( 0xffffff, 0, 0, Math.PI / 4)
